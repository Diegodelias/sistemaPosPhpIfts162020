    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
             ...
             <table class="table table-bordered table-striped display nowrap tablas " style="width:100%">    <!-- plugin data tables -->
              <thead>
                ...
                <tbody>
                      ...
                      $resp = VentasControlador::verVentasControl($nomCol, $val);

                      // var_dump($resp);
                      foreach ($resp as $indice => $value){
                          echo '   <tr>
                                  ...
                                  $respColCliente ="id";
                                  $valIdDeCli = $value["id_cliente"];
                                  $respuestaCliente = ClientesControlador::ClientesVerContr( $respColCliente, $valIdDeCli);


                                   echo '<td>'.$respuestaCliente["nombre"].'</td>';

                                  $respColUsuario ="id";
                                  $valIdDeUsuario = $value["id_vendedor"];
                                  $respuestaUsuario = ControladorUsuarios::ctrMostrarUsuarios( $respColUsuario, $valIdDeUsuario);
                                  ...
                                  <div class="btn-group">
                                    ...
                                    <button class="btn btn-outline-secondary EditarVentaBoton" idVenta="'.$value["id"].'" ><i class="fas fa-pencil-alt"></i></button>';
                                    
                                    if ($_SESSION["perfil"] == "Administrador"){

                                      echo '
                                        
                                      <button class="btn btn-outline-secondary btnEliminarVenta" idVenta="'.$value["id"].'" ><i class="fas fa-trash"></i></button>
             ...
             <?php
    $EliminarVenta = new VentasControlador();
    $EliminarVenta -> EliminarVentaControlador();
